...
#newdata: refers to the output (results or subset) data frame.

###Example:
#Subset_data(data=rawdata,cols="a x", newdata=rawdata_subset, drop=0) - To keep variables 'a' and 'x'
#Subset_data(data=rawdata,cols="a x", newdata=rawdata_subset, drop=1) - To drop variables 'a' and 'x'
